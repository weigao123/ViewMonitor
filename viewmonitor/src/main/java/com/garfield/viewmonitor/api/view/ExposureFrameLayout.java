...
public class ExposureFrameLayout<T> extends FrameLayout implements ExposureView<T> {
    ...
    public ExposureFrameLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ExposureFrameLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
